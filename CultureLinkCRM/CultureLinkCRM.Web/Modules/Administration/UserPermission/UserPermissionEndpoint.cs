using MyRepository = CultureLinkCRM.Administration.Repositories.UserPermissionRepository;
using MyRow = CultureLinkCRM.Administration.UserPermissionRow;

namespace CultureLinkCRM.Administration.Endpoints;
