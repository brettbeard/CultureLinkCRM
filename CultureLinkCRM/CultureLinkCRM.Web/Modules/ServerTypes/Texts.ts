...
namespace CultureLinkCRM.Texts {
    ...
    export declare namespace Db {
        ...
        namespace CrmDB {
            ...
            namespace Address {
                ...
                export const InternationalLine1: string;
                export const InternationalLine2: string;
                export const InternationalLine3: string;
                export const JurisdictionAbbreviation: string;
                export const JurisdictionId: string;
                export const JurisdictionName: string;
                export const MailCode: string;
                export const PostalCode: string;
                export const ZipCodeId: string;
                export const ZipCodeName: string;
            }
            ...
            namespace Contact {
                ...
                export const TaxCategoryId: string;
                export const TaxCategoryName: string;
            ...
            namespace ContactAddress {
                ...
                export const CityId: string;
                export const CityName: string;
                export const ContactAddressId: string;
                export const ContactId: string;
            ...
            namespace ContactPerson {
                export const ContactId: string;
                export const ContactName: string;
                export const ContactPersonId: string;
                export const Future: string;
            ...
            namespace Jurisdiction {
                ...
                export const JurisdictionId: string;
                export const JurisdictionTypeId: string;
                export const JurisdictionTypeSystemCode: string;
                export const ListInd: string;
                export const Name: string;
            }
            ...
            namespace TaxCategory {
                export const SystemCode: string;
    ...
    CultureLinkCRM['Texts'] = proxyTexts(Texts, '', {
        Db: {
            Administration: {
                Language: {},
                Role: {},
...
export const Texts = CultureLinkCRM.Texts;